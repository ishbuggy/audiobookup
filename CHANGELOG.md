...
- **No more stray chapter marks from the Audible branding trim:** With the branding-trim option enabled, a book whose chapter data places a marker inside Audible's closing branding could end up with a bit of that outro audible at the end of the last chapter, and a leftover chapter mark pointing past the end of the book. Those markers are now removed and chapter timings are kept within the trimmed audio.

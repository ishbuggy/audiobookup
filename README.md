...
- **Split by chapter** — optionally save each chapter as its own fully-tagged file in a folder per book, instead of one single audiobook file, in any of the three output formats.
